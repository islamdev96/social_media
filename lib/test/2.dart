...
///
class ResponsiveNavigationBar2 extends StatelessWidget {
  /// Put this in [Scaffold]'s [bottomNavigationBar]
  const ResponsiveNavigationBar2({
  ...
  /// Blur factor, from the [ResponsiveNavigationBar2]'s top
...
class NavigationBarButton {
  /// Put this in [ResponsiveNavigationBar2]'s [navigationBarButtons]
  ///
  /// [ NavigationBarButton(...), NavigationBarButton(...), ... ]
  ...
  /// [ResponsiveNavigationBar2]'s [textStyle].
